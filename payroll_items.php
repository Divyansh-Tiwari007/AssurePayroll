			...
			<div class="col-lg-12">
				...
				<div class="card">
					<div class="card-header">
						...
						<button class="btn btn-primary btn-sm btn-block col-md-2 float-right" type="button" id="new_payroll_btn" style="background-color: #28a745;color: white;font-weight: 700;"><span class="fa fa-plus"></span> Re-Caclulate Payroll</button>
					</div>
					<div class="card-body">
						<div class="row">
							<div class="col-md-12">
