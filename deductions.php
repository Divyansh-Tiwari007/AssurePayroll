...
<div class="container-fluid">
	...
	<div class="col-lg-12">
		<div class="row">
			...
			<form action="" id="manage-deductions">
				<div class="card">
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								<button class="btn btn-sm btn-primary col-sm-3 offset-md-3" style="background-color: #28a745;color: white;font-weight: 700;"> Save</button>
			...
			<div class="col-md-8">
				<div class="card">
					<div class="card-body" style="padding: 2.00rem">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_deductions" style="background-color:#28a745;color: white;font-weight: 700;"type="button" data-id="<?php echo $row['id'] ?>" data-deduction="<?php echo $row['deduction'] ?>" data-description="<?php echo $row['description'] ?>" >Edit</button>
